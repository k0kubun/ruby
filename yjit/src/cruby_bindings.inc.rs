...
pub const YARVINSN_zjit_opt_send_without_block: ruby_vminsn_type = 233;
pub const YARVINSN_zjit_objtostring: ruby_vminsn_type = 234;
pub const YARVINSN_zjit_opt_nil_p: ruby_vminsn_type = 235;
pub const YARVINSN_zjit_invokesuper: ruby_vminsn_type = 236;
pub const YARVINSN_zjit_invokeblock: ruby_vminsn_type = 237;
