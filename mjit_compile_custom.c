...
mjit_compile_custom(FILE *f, const rb_iseq_t *iseq, struct compile_status *status)
{
    ...
    fprintf(f, "    stack_0 = *(vm_get_ep(GET_EP(), 0) - 0x5);\n");
    ...
    fprintf(f, "    vm_env_write(vm_get_ep(GET_EP(), 0), -(int)0x3, stack_0);\n");
    ...
    fprintf(f, "    stack_1 = *(vm_get_ep(GET_EP(), 0) - 0x3);\n");
    ...
    fprintf(f, "    stack_1 = *(vm_get_ep(GET_EP(), 0) - 0x5);\n");
    ...
    fprintf(f, "    stack_2 = *(vm_get_ep(GET_EP(), 0) - 0x5);\n");
