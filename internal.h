...
VALUE rb_int_lt(VALUE x, VALUE y);
VALUE rb_int_le(VALUE x, VALUE y);
...
VALUE rb_flo_mod(VALUE x, VALUE y);
VALUE rb_flo_lt(VALUE x, VALUE y);
VALUE rb_flo_le(VALUE x, VALUE y);
VALUE rb_flo_ge(VALUE x, VALUE y);
VALUE rb_int2str(VALUE num, int base);
VALUE rb_dbl_hash(double d);
VALUE rb_fix_plus(VALUE x, VALUE y);
VALUE rb_int_gt(VALUE x, VALUE y);
int rb_float_cmp(VALUE x, VALUE y);
VALUE rb_flo_gt(VALUE x, VALUE y);
...
/* vm_insnhelper.c */
VALUE rb_opt_int_plus(VALUE recv, VALUE obj);
...
VALUE rb_opt_int_mul(VALUE recv, VALUE obj);
VALUE rb_opt_flo_mul(VALUE recv, VALUE obj);
VALUE rb_opt_int_div(VALUE recv, VALUE obj);
VALUE rb_opt_flo_div(VALUE recv, VALUE obj);
VALUE rb_opt_int_mod(VALUE recv, VALUE obj);
VALUE rb_opt_flo_mod(VALUE recv, VALUE obj);
VALUE rb_equal_opt(VALUE obj1, VALUE obj2);
VALUE rb_eql_opt(VALUE obj1, VALUE obj2);
VALUE rb_opt_int_lt(VALUE recv, VALUE obj);
VALUE rb_opt_flo_lt(VALUE recv, VALUE obj);
VALUE rb_opt_int_le(VALUE recv, VALUE obj);
VALUE rb_opt_flo_le(VALUE recv, VALUE obj);
VALUE rb_opt_int_gt(VALUE recv, VALUE obj);
