...
mod hir_opt_tests {
    ...
    fn reload_local_across_send_after_ep_escape() {
        ...
        bb3(v10:BasicObject, v11:NilClass):
          ...
          v47:ObjectSubclass[class_exact*:Object@VALUE(0x1008)] = GuardType v10, ObjectSubclass[class_exact*:Object@VALUE(0x1008)]
    ...
    fn test_invokesuper_with_blockarg_remains_invokesuper() {
        ...
        bb2():
          ...
          Jump bb3(v7, v8, v11)
        bb3(v14:BasicObject, v15:BasicObject, v16:NilClass):
          PatchPoint NoSingletonClass(B@0x1008)
          PatchPoint MethodRedefined(B@0x1008, proc@0x1010, cme:0x1018)
          v42:ObjectSubclass[class_exact:B] = GuardType v14, ObjectSubclass[class_exact:B]
    ...
    fn recompile_after_ep_escape_uses_ep_locals() {
        ...
        bb11():
          ...
          v133:ObjectSubclass[class_exact*:Object@VALUE(0x1010)] = GuardType v73, ObjectSubclass[class_exact*:Object@VALUE(0x1010)]
