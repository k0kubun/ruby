...
pub(crate) mod hir_build_tests {
    ...
    fn test_send_with_anonymous_block_param() {
        ...
        bb6(v22:BasicObject, v23:BasicObject):
          v36:ObjectSubclass[BlockParamProxy] = Const Value(VALUE(0x1038))
        ...
        bb8():
          ...
          v41:CBool = HasType v9, ObjectSubclass[class_exact*:Object@VALUE(0x1040)]
          CondBranch v41, bb11(), bb12()
        bb11():
          v44:ObjectSubclass[class_exact*:Object@VALUE(0x1040)] = RefineType v9, ObjectSubclass[class_exact*:Object@VALUE(0x1040)]
    ...
    fn test_compile_triple_dots_with_positional_args() {
        ...
        bb9():
          ...
          CondBranch v50, bb8(), bb10()
        bb8():
          v52:NilClass = Const Value(nil)
          Jump bb6(v52, v21)
        bb6(v34:BasicObject, v35:BasicObject):
          v56:NilClass|HashExact = ToHash v20
          v58:BasicObject = Send v17, &block, :foo, v18, v29, v56, v34 # SendFallbackReason: Uncategorized(send)
          CheckInterrupts
          Return v58
        bb10():
    ...
    fn test_getblockparamproxy() {
        ...
        bb6(v15:BasicObject, v16:BasicObject):
          v37:BasicObject = Send v9, &block, :tap, v15 # SendFallbackReason: Uncategorized(send)
          CheckInterrupts
          Return v37
        bb10():
          SideExit BlockParamProxyProfileNotCovered
    ...
    fn test_getblockparamproxy_modified() {
        ...
        bb9(v30:BasicObject, v31:BasicObject):
          v52:BasicObject = Send v11, &block, :tap, v30 # SendFallbackReason: Uncategorized(send)
          CheckInterrupts
          Return v52
        bb13():
          SideExit BlockParamProxyProfileNotCovered
    ...
    fn test_getblockparamproxy_modified_nested_block() {
        ...
        bb11():
          ...
          Jump bb9(v43)
        bb9(v26:BasicObject):
          v47:BasicObject = Send v8, &block, :tap, v26 # SendFallbackReason: Uncategorized(send)
          CheckInterrupts
          Return v47
        bb13():
          SideExit BlockParamProxyProfileNotCovered
    ...
    fn test_splatkw_unprofiled_converts_generically() {
        ...
        bb9():
          ...
          CondBranch v35, bb8(), bb10()
        bb8():
          v37:NilClass = Const Value(nil)
          Jump bb6(v37, v13)
        bb6(v19:BasicObject, v20:BasicObject):
          v41:NilClass|HashExact = ToHash v12
          v43:BasicObject = Send v11, &block, :foo, v41, v19 # SendFallbackReason: Uncategorized(send)
          CheckInterrupts
          Return v43
        bb10():
          SideExit BlockParamProxyProfileNotCovered
    ...
    fn test_invokebuiltin_delegate_with_args() {
        ...
        bb11():
          ...
          CondBranch v49, bb10(), bb12()
        bb10():
          v51:NilClass = Const Value(nil)
          Jump bb8(v51, v22)
        bb8(v33:BasicObject, v34:BasicObject):
          v55:CBool = Test v33
          v56:Falsy = RefineType v33, Falsy
          CondBranch v55, bb13(), bb4(v18, v19, v20, v21, v34, v27)
        bb13():
          v58:Truthy = RefineType v33, Truthy
          v62:CPtr = GetEP 0
          v63:CInt64 = LoadField v62, :VM_ENV_DATA_INDEX_SPECVAL@0x1006
          v64:CInt64[3] = Const CInt64(3)
          v65:CInt64 = IntAnd v63, v64
          v67:CInt64[3] = Const CInt64(3)
          v68:CBool = IsBitEqual v65, v67
          CondBranch v68, bb16(), bb17()
        bb16():
        ...
        bb17():
          ...
          CondBranch v73, bb18(), bb15()
        bb18():
          v75:CInt64[-4] = Const CInt64(-4)
          v76:CInt64 = IntAnd v63, v75
          v77:CPtr = LoadField v76, :code_iseq@0x1010
          v78:BasicObject = InvokeBlockIseqDynamic v76, v27 # SendFallbackReason: InvokeBlock: run-time block ISEQ is not directly callable
          Jump bb14(v78)
        bb15():
          BlockReprofile v63
          v81:BasicObject = InvokeBlock v27 # SendFallbackReason: InvokeBlock: no block handler profile
          Jump bb14(v81)
        bb14(v66:BasicObject):
          v85:BasicObject = InvokeBuiltin dir_s_close, v18, v27
          CheckInterrupts
          Return v66
        bb4(v91:BasicObject, v92:BasicObject, v93:BasicObject, v94:BasicObject, v95:BasicObject, v96:BasicObject):
          CheckInterrupts
          Return v96
        bb12():
          SideExit BlockParamProxyProfileNotCovered
    ...
    fn test_array_each() {
        ...
        bb7(v70:BasicObject, v71:Fixnum):
          ...
          CondBranch v85, bb14(), bb15()
        bb14():
          v87:BasicObject = InvokeBlockIfunc v80, v77
          Jump bb12(v87)
        bb15():
          v89:CInt64[1] = Const CInt64(1)
          v90:CBool = IsBitEqual v82, v89
          CondBranch v90, bb16(), bb13()
        bb16():
          v92:CInt64[-4] = Const CInt64(-4)
          v93:CInt64 = IntAnd v80, v92
          v94:CPtr = LoadField v93, :code_iseq@0x1001
          v95:BasicObject = InvokeBlockIseqDynamic v93, v77 # SendFallbackReason: InvokeBlock: run-time block ISEQ is not directly callable
          Jump bb12(v95)
        bb13():
          BlockReprofile v80
          v98:BasicObject = InvokeBlock v77 # SendFallbackReason: InvokeBlock: no block handler profile
          Jump bb12(v98)
        bb12(v83:BasicObject):
          v103:Fixnum[1] = Const Value(1)
          v104:Fixnum = FixnumAdd v71, v103
