...
use crate::cruby::{IseqPtr, Qundef, RUBY_OFFSET_CFP_ISEQ, RUBY_OFFSET_CFP_JIT_RETURN, RUBY_OFFSET_CFP_PC, RUBY_OFFSET_CFP_SP, SIZEOF_VALUE_I32, vm_stack_canary, zjit_jit_frame, zjit_opnd_t};
    ...
    fn next(&mut self) -> Option<Self::Item> {
        match self.insn {
            ...
            Insn::CCall { opnds, stack_map, .. } => {
                ...
                let stack_idx = self.idx - opnds.len();
                        ...
                        for stack_opnd in stack.iter() {
                            ...
                            match stack_opnd {
                                Opnd::UImm(value) => {
                                    ...
                                    unsafe { (&raw mut (*ptr).as_.bindgen_union_field).write(*value) };
                                }
