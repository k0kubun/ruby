...
mod tests {
    ...
    fn test_lir_string() {
        ...
        let side_exit = Target::SideExit { reason: SideExitReason::Interrupt, exit: SideExit { self_opnd: Qnil.into(), pc: 0.into(), iseq: std::ptr::null(), stack: vec![], locals: vec![], recompile: None } };
