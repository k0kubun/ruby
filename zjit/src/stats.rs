...
make_counters! {
    ...
    default {
        ...
        // subset whose ISEQ the GC has since freed. The payload itself is freed
        // then; the `IseqVersion`s it pointed at outlive it (see
        ...
        compile_hir_fuse_fixnum_compare_branches_time_ns,
    ...
    dynamic_send {
        ...
        send_fallback_invokeblock_complex_args,
        send_fallback_invokeblock_no_profile,
        send_fallback_invokeblock_handler_not_iseq_profile,
        send_fallback_invokeblock_megamorphic_profile,
        send_fallback_invokeblock_chain_coverage,
        send_fallback_invokeblock_not_simple_iseq,
        send_fallback_invokeblock_arity_mismatch,
        send_fallback_invokeblock_ambiguous_param0,
    ...
    dynamic_setivar {
        ...
        setivar_fallback_shape_chain_miss,
    }
    ...
    dynamic_getivar {
        ...
        getivar_fallback_shape_chain_miss,
    }
    ...
    // probe: an immediate receiver, a table miss, or a target that is not a
    // simple ISEQ method -- which every cfunc target is, and the attribute
    // readers a Symbol block usually names are not. Counted next to
    // send_megamorphic_direct, which counts the calls the probe did answer.
...
pub fn side_exit_counter(reason: crate::hir::SideExitReason) -> Counter {
    ...
    match reason {
        ...
        NoProfileExpandArray          => exit_no_profile_expandarray,
...
pub fn send_fallback_counter(reason: crate::hir::SendFallbackReason) -> Counter {
    ...
    match reason {
        ...
        InvokeBlockNoProfile                      => send_fallback_invokeblock_no_profile,
        InvokeBlockHandlerNotIseqProfile          => send_fallback_invokeblock_handler_not_iseq_profile,
        InvokeBlockMegamorphicProfile             => send_fallback_invokeblock_megamorphic_profile,
        InvokeBlockChainCoverage                  => send_fallback_invokeblock_chain_coverage,
        InvokeBlockNotSimpleIseq                  => send_fallback_invokeblock_not_simple_iseq,
        InvokeBlockArityMismatch                  => send_fallback_invokeblock_arity_mismatch,
        InvokeBlockAmbiguousParam0                => send_fallback_invokeblock_ambiguous_param0,
...
pub extern "C" fn rb_zjit_stats(_ec: EcPtr, _self: VALUE, target_key: VALUE) -> VALUE {
    ...
    // an outlined (cold) half; report the bytes written into each so the density
    // of the hot half is visible on its own.
