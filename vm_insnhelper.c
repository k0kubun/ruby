...
static VALUE
vm_opt_div_int(VALUE recv, VALUE obj)
{
    if (FIXNUM_2_P(recv, obj) &&
...
static VALUE
vm_opt_div_float(VALUE recv, VALUE obj)
{
    if (FLONUM_2_P(recv, obj) &&
...
static VALUE
vm_opt_le_int(VALUE recv, VALUE obj)
{
    if (FIXNUM_2_P(recv, obj) &&
...
static VALUE
vm_opt_le_float(VALUE recv, VALUE obj)
{
    if (FLONUM_2_P(recv, obj) &&
...
static VALUE
vm_opt_gt_int(VALUE recv, VALUE obj)
{
    if (FIXNUM_2_P(recv, obj) &&
...
static VALUE
vm_opt_gt_float(VALUE recv, VALUE obj)
{
    if (FLONUM_2_P(recv, obj) &&
...
static VALUE
vm_opt_ge_int(VALUE recv, VALUE obj)
{
    if (FIXNUM_2_P(recv, obj) &&
...
static VALUE
vm_opt_ge_float(VALUE recv, VALUE obj)
{
    if (FLONUM_2_P(recv, obj) &&
