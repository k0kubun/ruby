...
void rb_zjit_materialize_locals(const rb_execution_context_t *ec, const rb_control_frame_t *cfp);
...
static inline void rb_zjit_materialize_locals(const rb_execution_context_t *ec, const rb_control_frame_t *cfp) {}
